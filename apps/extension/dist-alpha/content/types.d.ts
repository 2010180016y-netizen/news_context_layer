...
export declare const PARSE_CONFIDENCE_BUCKETS: readonly ["high", "medium", "low"];
...
export type ParsedFieldName = 'canonical_url' | 'title' | 'publisher_name' | 'author_names' | 'published_at' | 'modified_at' | 'article_type' | 'section' | 'keywords' | 'og_description' | 'body_excerpt';
