...
import type { ArticleFeatureRecord, CanonicalArticleRecord, SubscriptionPlanCode, SubscriptionStatus } from './store.js';
...
export declare const CHECKOUT_PLAN_CODES: readonly ["founder_pass"];
export declare const PAYWALL_TRIGGER_TYPES: readonly ["watchlist_limit", "briefing", "upgrade_cta", "history"];
...
export declare const TRACKED_EVENT_NAMES: readonly ["panel_opened", "article_parsed", "context_loaded", "related_article_clicked", "watchlist_saved", "paywall_viewed", "checkout_started", "purchase_completed", "feedback_submitted"];
